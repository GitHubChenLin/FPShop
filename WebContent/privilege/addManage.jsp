...
<body>
	<div class="add">
		...
		<div style="font-size: 15px; color: rgb(241, 55, 53);">新增地址</div>
		<form class="add_form"
			action="${pageContext.request.contextPath}/userservlet?method=addManage"
			method="post">
			<table class="add_table">
				...
				<tr>
					<td>详细地址：</td>
					<td><input type="text" name="add" style="width: 300px;"></td>
				</tr>
				<tr>
					<td>联系方式：</td>
